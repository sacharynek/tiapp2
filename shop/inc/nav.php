			<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="http://localhost/tiapp2/shop/index.php">Home</a>
					</li>
					<li>
						<a href="#">Shop</a>
					...
					<li>
						...
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="http://localhost/tiapp2/shop/my-account.php">My Orders</a></li>
							<li><a href="http://localhost/tiapp2/shop/edit-address.php">Update Address</a></li>
							<li><a href="http://localhost/tiapp2/shop/logout.php">Logout</a></li>
						</ul>
					</li>
					<li>
						<a href="#">Contact</a>
